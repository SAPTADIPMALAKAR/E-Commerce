...
import HeroImg from '../assets/images/piyush-haswani-gAVIw1zs1fU-unsplash.jpg';
        ...
        <div className="hero__wrapper">
          <div className="hero__info">
            <HeroTitle className="hero__title">
              The Best Jordan Store.
            </HeroTitle>
            <ParagraphText className="hero__desc">
              Because every sneaker tells a story, let us help you tell yours.
            </ParagraphText>
            <PrimaryButton
              buttonType={Link}
              smooth
